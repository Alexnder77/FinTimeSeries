...
lines(OMXS30_common$Date, OMXS30_common$Normalized, col = "green")
...
adf_test_OMXC20 <- adf.test(merged_data$OMXC20_Close, alternative = "stationary")

# Run the ADF test on OMXS30 Close prices
adf_test_OMXS30 <- adf.test(merged_data$OMXS30_Close, alternative = "stationary")
